...
func (b *Bot) SendNotice(roomID id.RoomID, message string, raw map[string]interface{}, relates ...*event.RelatesTo) id.EventID {
	...
	eventID, err := b.lp.Send(roomID, fullContent)
	if err != nil {
