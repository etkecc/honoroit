...
func X__istype(tls *TLS, _c int32, _f uint64) int32 {
	if __ccgo_strace {
...
func X__isctype(tls *TLS, _c int32, _f uint64) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v _f=%v, (%v:)", tls, _c, _f, origin(2))
	}
...
func X__wcwidth(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
...
func Xisalnum(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xisalpha(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xisblank(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xiscntrl(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xisdigit(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xisgraph(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xislower(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xisprint(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xispunct(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xisupper(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xisxdigit(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xtoascii(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
	return _c & 0x7F
...
func Xdigittoint(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xishexnumber(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xisideogram(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xisnumber(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xisphonogram(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xisrune(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func Xisspecial(tls *TLS, _c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v _c=%v, (%v:)", tls, _c, origin(2))
	}
...
func X__toupper(tls *TLS, c int32) int32 {
	if __ccgo_strace {
...
func X__tolower(tls *TLS, c int32) int32 {
	if __ccgo_strace {
		trc("tls=%v c=%v, (%v:)", tls, c, origin(2))
	}
...
var X_CurrentRuneLocale uintptr = 0
...
type pthread_mutexattr_t = struct{ F__attr uint32 }

type pthread_condattr_t = struct{ F__attr uint32 }

type pthread_barrierattr_t = struct{ F__attr uint32 }

type pthread_rwlockattr_t = struct{ F__attr [2]uint32 }

type __sigset_t = struct{ F__bits [16]uint64 }
...
func Xgethostbyaddr_r(tls *TLS, a uintptr, l socklen_t, af int32, h uintptr, buf uintptr, buflen size_t, res uintptr, err uintptr) int32 {
	...
	*(*struct {
	...
	(*sockaddr_in)(unsafe.Pointer(bp)).Fsin_family = sa_family_t(af)
	var sl socklen_t
	if af == 10 {
	...
	for Xfgets(tls, bp+16, int32(unsafe.Sizeof([512]int8{})), f) != 0 {
		...
		*(*int8)(unsafe.Pointer(PostIncUintptr(&p, 1))) = int8(0)
		...
		if (*address)(unsafe.Pointer(bp+528)).Ffamily == 2 {
			...
			(*address)(unsafe.Pointer(bp + 528)).Fscopeid = uint32(0)
		}
...
func X__lookup_name(tls *TLS, buf uintptr, canon uintptr, name uintptr, family int32, flags int32) int32 {
	...
	*(*int8)(unsafe.Pointer(canon)) = int8(0)
	...
	for i = 0; i < cnt; i++ {
		...
		*(*sockaddr_in6)(unsafe.Pointer(bp)) = sockaddr_in6{Fsin6_family: sa_family_t(10), Fsin6_port: in_port_t(65535), Fsin6_scope_id: (*address)(unsafe.Pointer(buf + uintptr(i)*28)).Fscopeid}
		*(*sockaddr_in)(unsafe.Pointer(bp + 72)) = sockaddr_in{}
		*(*sockaddr_in)(unsafe.Pointer(bp + 56)) = sockaddr_in{Fsin_family: sa_family_t(2), Fsin_port: in_port_t(65535)}
		var sa1 uintptr
		var da uintptr
...
func init() {
	*(*uintptr)(unsafe.Pointer(uintptr(unsafe.Pointer(&X_CurrentRuneLocale)) + 0)) = uintptr(unsafe.Pointer(&X_DefaultRuneLocale))
	*(*uintptr)(unsafe.Pointer(uintptr(unsafe.Pointer(&X_CurrentRuneLocale)) + 0)) = uintptr(unsafe.Pointer(&X_DefaultRuneLocale))
}
