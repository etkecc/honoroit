...
func X__floatscan(tls *TLS, f uintptr, prec int32, pok int32) float64 {
	...
	for i = size_t(0); i < size_t(8) && c|32 == int32(*(*int8)(unsafe.Pointer(ts + 41 + uintptr(i)))); i++ {
		if i < size_t(7) {
			c = func() int32 {
				if (*FILE)(unsafe.Pointer(f)).Frpos != (*FILE)(unsafe.Pointer(f)).Fshend {
					return int32(*(*uint8)(unsafe.Pointer(PostIncUintptr(&(*FILE)(unsafe.Pointer(f)).Frpos, 1))))
	...
	if !(i != 0) {
		for i = size_t(0); i < size_t(3) && c|32 == int32(*(*int8)(unsafe.Pointer(ts + 50 + uintptr(i)))); i++ {
			if i < size_t(2) {
				c = func() int32 {
					if (*FILE)(unsafe.Pointer(f)).Frpos != (*FILE)(unsafe.Pointer(f)).Fshend {
						return int32(*(*uint8)(unsafe.Pointer(PostIncUintptr(&(*FILE)(unsafe.Pointer(f)).Frpos, 1))))
...
var _sxdigits = *(*[17]int8)(unsafe.Pointer(ts + 98))
