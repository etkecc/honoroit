...
type dirstream_buf_alignment_check = [1]int8
...
func X__floatscan(tls *TLS, f uintptr, prec int32, pok int32) float64 {
	...
	for i = size_t(0); i < size_t(8) && c|32 == int32(*(*int8)(unsafe.Pointer(ts + uintptr(i)))); i++ {
		if i < size_t(7) {
			c = func() int32 {
				if (*FILE)(unsafe.Pointer(f)).rpos != (*FILE)(unsafe.Pointer(f)).shend {
					return int32(*(*uint8)(unsafe.Pointer(PostIncUintptr(&(*FILE)(unsafe.Pointer(f)).rpos, 1))))
	...
	if !(i != 0) {
		for i = size_t(0); i < size_t(3) && c|32 == int32(*(*int8)(unsafe.Pointer(ts + 9 + uintptr(i)))); i++ {
			if i < size_t(2) {
				c = func() int32 {
					if (*FILE)(unsafe.Pointer(f)).rpos != (*FILE)(unsafe.Pointer(f)).shend {
						return int32(*(*uint8)(unsafe.Pointer(PostIncUintptr(&(*FILE)(unsafe.Pointer(f)).rpos, 1))))
...
type a_cas_p_undefined_but_pointer_not_32bit = [1]int8
...
var _sxdigits = *(*[17]int8)(unsafe.Pointer(ts + 59))
...
__110:
	...
	switch Xmbrtowc(tls, bp+260, func() uintptr { *(*int8)(unsafe.Pointer(bp + 264)) = int8(c); return bp + 264 }(), uint32(1), bp+268) {
