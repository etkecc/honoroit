...
func X__isalnum_l(tls *TLS, c int32, l locale_t1) int32 {
	if __ccgo_strace {
...
func X__isalpha_l(tls *TLS, c int32, l locale_t1) int32 {
	if __ccgo_strace {
		trc("tls=%v c=%v l=%v, (%v:)", tls, c, l, origin(2))
	}
	return Xisalpha(tls, c)
...
func X__isdigit_l(tls *TLS, c int32, l locale_t1) int32 {
	if __ccgo_strace {
		trc("tls=%v c=%v l=%v, (%v:)", tls, c, l, origin(2))
	}
	return Xisdigit(tls, c)
...
func X__isprint_l(tls *TLS, c int32, l locale_t1) int32 {
	if __ccgo_strace {
		trc("tls=%v c=%v l=%v, (%v:)", tls, c, l, origin(2))
	}
...
func X__shlim(tls *TLS, f uintptr, lim off_t1) {
	if __ccgo_strace {
...
type __sigset_t = struct{ F__bits [32]uint32 }

type sigset_t = __sigset_t

type pthread_attr_t = struct{ F__u struct{ F__i [9]int32 } }

type pthread_mutex_t = struct{ F__u struct{ F__i [6]int32 } }

type pthread_cond_t = struct{ F__u struct{ F__i [12]int32 } }

type pthread_rwlock_t = struct{ F__u struct{ F__i [8]int32 } }

type pthread_barrier_t = struct{ F__u struct{ F__i [5]int32 } }
...
var _sxdigits = *(*[17]uint8)(unsafe.Pointer(ts + 57))
...
func init() {
	*(*uintptr)(unsafe.Pointer(uintptr(unsafe.Pointer(&X_ctype_tab_)) + 0)) = uintptr(unsafe.Pointer(&X_C_ctype_tab_))
	*(*uintptr)(unsafe.Pointer(uintptr(unsafe.Pointer(&X_ctype_tab_)) + 0)) = uintptr(unsafe.Pointer(&X_C_ctype_tab_))
}
