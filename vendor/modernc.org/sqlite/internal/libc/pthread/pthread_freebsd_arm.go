...
type X_cpuset = struct{ F__bits [8]int32 }

type Cpuset_t = X_cpuset
type Cpu_set_t = X_cpuset
...
type X_pthread_cleanup_info = struct{ Fpthread_cleanup_pad [8]X__uintptr_t }
